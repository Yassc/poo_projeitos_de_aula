...
public class Main {
    public static void main(String[] args) {
        ...
        while (menu != 5) {
            ...
            System.out.println("\n--- MENU CINEMA ---");
            System.out.println("1. Adicionar GerenciadorDeFilmes.Filme");
            ...
            try {
                switch (menu) {
                    case 1:
                        ...
                        System.out.println("GerenciadorDeFilmes.Filme cadastrado!");
                        break;
                    ...
                    case 3:
                        System.out.print("GerenciadorDeFilmes.Filme que deseja adicionar à lista de favoritos: ");
